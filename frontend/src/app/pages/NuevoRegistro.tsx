...
export default function NuevoRegistro() {
  ...
  const [formData, setFormData] = useState<NuevaMarca>({
    nombre: "",
    titular: "",
    categoria: "",
    descripcion: ""
  ...
  const handleInputChange = (field: keyof NuevaMarca, value: string) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  const handleSubmit = async () => {
    try {
      ...
      toast({
        ...
        description: `La marca "${formData.nombre}" ha sido registrada correctamente.`,
      });
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 max-w-md mx-auto">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="categoria"
                  placeholder="Ej: Tecnología, Alimentación, Servicios"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="descripcion"
                  placeholder="Describe brevemente la marca y su propósito..."
